...
export const loadNetwork = async (provider , dispatch)=>{
 ...
 //load user balances (wallet and exchange)
   export const loadBalances = async(exchange , tokens , account , dispatch) => {
    ...
    dispatch ({type : 'EXCHANGE_TOKEN _1_BALANCE_LOADED' , balance})
    ...
    dispatch ({type : 'EXCHANGE_TOKEN _2_BALANCE_LOADED' , balance})
...
//--------------------------------
 ...
 export const transferTokens = async(provider , exchange , tranferType, token , amount , dispatch ) =>{
    let transaction 
